					...
					>
						...
						<div className='lg:mt-5'>
							<p className='font-bold mb-1 lg:hidden text-md xs:text-md'>
								...
								in my spare time (when I&apos;m not coding). Accustomed to using
								extensive tech stack because I love challenging and complex
								projects.
							</p>
			...
			<div className='bg-teal-900'>
				<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 1440 320'>
					<path
						fill='#171717'
						fill-opacity='1'
						d='M0,192L48,197.3C96,203,192,213,288,224C384,235,480,245,576,240C672,235,768,213,864,176C960,139,1056,85,1152,90.7C1248,96,1344,160,1392,192L1440,224L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z'
					></path>
				</svg>
			</div>
			{/* <FeaturedPosts /> */}
