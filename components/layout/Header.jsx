...
const Header = () => {
	return (
		<NavigationMenu.Root className="sticky top-0 z-10 flex w-screen justify-center bg-transparent pt-5"> 
			...
			<NavigationMenu.Item>
					<NavigationMenu.Link
						className="block select-none rounded px-3 py-2 text-[15px] font-medium leading-none text-blue9 no-underline outline-none hover:bg-violet3 focus:shadow-[0_0_0_2px] focus:shadow-violet7"
						href="/"
					>
						Home
					</NavigationMenu.Link>
				...
				<NavigationMenu.Item>
					<NavigationMenu.Trigger className="group flex select-none items-center justify-between gap-0.5 rounded px-3 py-2 text-[15px] font-medium leading-none text-blue9 outline-none hover:bg-violet3 focus:shadow-[0_0_0_2px] focus:shadow-violet7">
						Blog{" "}
						<CaretDownIcon
