...
const LibaryCard = ({ libary }) => {
   return (
      <div
         key={libary.slug}
         className={clsx(libary.inPreparation ? "text-slate-600 pointer-events-none bg-neutral-800 " :
         ...
         <a href={`/libary/${libary.slug}`}>
            ...
            <div  className=" bg-gradient-to-r from-lime-700 to-teal-700 origin-top float-right mt-6 mr-6 w-36 text-center text-slate-200" 
            style={{transform:"translateX(54%) rotate(50deg)"}} >
               <div className="text-xs py-1">Comming soon</div>
            </div> : <div  className="origin-top float-right mt-4 mr-2 w-8 text-right text-slate-200 " > 
            ...
            <div className='px-3 my-3 '>
               ...
               <h1 className='text-lg font-bold  whitespace-normal break-normal'> {libary.title}</h1>
