...
const PostCard = ({ post }) => {
	return (
		<div className='bg-slate-900 shadow-lg   first:mt-5 lg:mt-5 sm:mt-10 lg:rounded-lg p-0 lg:p-0 lg:pb-7 pb-12 md-8 mb-12 lg:md-14'>
			...
			<div className=' bg-slate-800 border-sky-900 border pb-5'>
            ...
            /> */}
				...
				<div className='text-center lg:mt-5'>
					<Link href={`/post/${post.slug}`}>
						<a className='inline-flex hover:animate-pulse'>
							<span className='h-12 flex items-center mt-3 justify-center  uppercase font-semibold px-5 border-2 border-sky-800 text-slate-400 hover:bg-sky-800 hover:text-white hover:border-slate-400 hover:cursor-pointer transition duration-500 ease-in-out'>
								Continue reading
								<span className='ml-2  '>
									<svg
										className='w-6 h-6'
