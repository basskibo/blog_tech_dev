      ...
      <div className='pt-16 pb-40 sm:pt-24 sm:pb-20 lg:pt-40 lg:pb-48'>
         <div className='relative max-w-7xl mx-auto px-4 lg:px-0 sm:static'>
            ...
            <div class='flex gap-6 flex-col md:flex-row mt-10'>
               <a
                  class='transform hover:scale-[1.01] transition-all rounded-xl w-full md:w-1/3 bg-gradient-to-r p-1 from-[#7928ca] to-[#ff0080]'
                  href='post/javascript-class-fundamentals'>
                  <div class='flex flex-col justify-between h-full bg-neutral-900  rounded-lg p-4'>
                     ...
                     <div class='flex items-center text-gray-800 dark:text-gray-200 capsize'>
                        ...
                        <span class='ml-2 align-baseline capsize'>10,250</span>
                     </div>
                  </div>
               </a>
               <a
                  class='transform hover:scale-[1.01] transition-all rounded-xl w-full md:w-1/3 bg-gradient-to-r p-1 from-[#6EE7B7] via-[#3B82F6] to-[#9333EA]'
                  ...
                  <div class='flex flex-col justify-between h-full bg-neutral-900  rounded-lg p-4'>
                     ...
                     <div class='flex items-center text-gray-800 dark:text-gray-200 capsize'>
                        <HiOutlineEye className='text-xl' />
                        <span class='ml-2 align-baseline capsize'>13,325</span>
                     </div>
                  </div>
               </a>
               <a
                  class='transform hover:scale-[1.01] transition-all rounded-xl w-full md:w-1/3 bg-gradient-to-r p-1 from-lime-500 via-[#b5d855] to-teal-700'
                  ...
                  <div class='flex flex-col justify-between h-full bg-neutral-900  rounded-lg p-4'>
                     ...
                     <div class='flex items-center text-gray-800 dark:text-gray-200 capsize'>
                        <HiOutlineEye className='text-xl' />
                        <span class='ml-2 align-baseline capsize'>8,326</span>
                     </div>
                  </div>
               </a>
            </div>
