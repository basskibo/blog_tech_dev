				...
				<MotionComponent>
					...
					<div className='  lg:px-0 py-3 mb-10 border-b border-gray-400'>
						<p className='mb-5'>
							...
							dolore adipisicing sint dolore nisi excepteur occaecat. Elit duis
							enim duis dolor tempor enim est labore occaecat. Exercitation laborum
							occaecat elit culpa esse excepteur.Cupidatat duis in nulla eu eu.
							Magna laboris fugiat excepteur in elit qui irure sit aliquip. Dolore
								...
								<div className='text-base font-normal text-gray-500 dark:text-gray-400'>
									<ul className='list-disc pl-5'>
										<li>
											...
											(HA) and scalable cloud service for various IoT
											applications.
										</li>
										<li>
											Description: Working on cloud integration of smart
											devices using Zigbee, Z Wave and Wise protocol,
											scalability of the system in order to support more than
											1milion mqtt clients (devices) with 100 thousand of
											docker containers which are IOT virtual device gateway ,
											maximizing application efficiency, data quality, scope,
											operability, and flexibility. Setting up new environments
											and working with multiple EMQX brokers, rabbitMQ and
											Redis clusters, MongoDB replication, making HA systems
											and ensuring high level of operational performance.
							...
							<li className='ml-4 mb-10'>
								...
								<div className='text-base mb-4  font-normal text-gray-500 dark:text-gray-400'>
									<ul className='list-disc pl-5'>
										...
										<li>
											Description: Working on development of a web platform
											that enables the audience on sports arena to participate
											in real time events/games. Involved in architecture
											structure, scalability and performance due to high load
								...
								<div className='mb-4 text-base font-normal text-gray-500 dark:text-gray-400'>
									<ul className='list-disc pl-5'>
										...
										<li>
											...
											households. Analyze code for system testing and
											debugging, isolate and rectify issues. Developed
											full-stack web applications which processed, analyzed,
											and rendered data visually using GIS.
										</li>
										<li>
											Assignments: Implementation, unit tests, documentation,
											user manuals, deployment on AWS ● Technologies: Nodejs,
