            ...
            <MotionComponent>
               <div className='  lg:px-0 py-3 mb-10 border-b border-gray-400'>
                  <p className='mb-5'>
                     ...
                     of working in the IT industry and especially in IOT in the
                     last years. Developed JSON RESTfull API services for new
                     web/ hybrid mobile apps , including OAuth, users profiles,
                     ...
                     Jenkins, etc.. Programming is my passion and I tend to
                     learn everyday new things and new technologies.
                  </p>
                  <p className='mb-10'>
                     If you like what I do,in order to be updated with latest
                     posts and to vote for new content please feel free to
                     donate whatever amount you like. Possible options are{" "}
                     <a
                  ...
                  <ol className='relative border-l border-gray-200 dark:border-gray-700'>
                     <li className='ml-4 mb-10'>
                        ...
                        <div className='text-base font-normal text-gray-500 dark:text-gray-400'>
                           <ul className='list-disc pl-5'>
                              ...
                              <li>
                                 Description: Working on cloud integration of
                                 smart devices using Zigbee, Z Wave and Wise
                                 protocol, scalability of the system in order to
                                 support more than 1milion mqtt clients
                                 (devices) with 100 thousand of docker
                                 containers which are IOT virtual device gateway
                                 , maximizing application efficiency, data
                                 quality, scope, operability, and flexibility.
                                 Setting up new environments and working with
                                 multiple EMQX brokers, rabbitMQ and Redis
                                 clusters, MongoDB replication, making HA
                              ...
                              <li>
                                 ...
                                 Express, AngularJs, Nodejs), React, MQTT
                                 broker( EMQX and mosca), NGINX, Docker, Redis,
                                 RabbitMQ, Kafka, AWS services , Jenkins, Zabbix
                                 , Ansible, NFS/EFS
                              </li>
                           </ul>
                        </div>
                        ...
                        <div className='text-base mb-4  font-normal text-gray-500 dark:text-gray-400'>
                           <ul className='list-disc pl-5'>
                              ...
                              <li>
                                 ...
                                 platform that enables the audience on sports
                                 arena to participate in real time events/games.
                                 Involved in architecture structure, scalability
                                 and performance due to high load of websocket
                                 connections.
                              </li>
                              <li>
                                 Key technologies used are Nodejs, SailsJs,
                                 MongoDB , Websockets (socket.io), AngularJS,
                                 AWS EC2, AWS S3
                              </li>
                           </ul>
                        </div>
                     ...
                     <li className='mb-10 ml-4'>
                        ...
                        <div className='mb-4 text-base font-normal text-gray-500 dark:text-gray-400'>
                           <ul className='list-disc pl-5'>
                              <li>
                                 Project: Software solution specialized in
                                 managing agriculture production processes and
                                 all types of lands, Mobile agro solutions{" "}
                              </li>
                              <li>
                                 Description: Develop, maintain and support
                                 web/mobile application for Agronomists and
                                 owners of agriculture households. Analyze code
                                 for system testing and debugging, isolate and
                                 rectify issues. Developed full-stack web
                                 applications which processed, analyzed, and
                                 rendered data visually using GIS.
                              </li>
                              <li>
