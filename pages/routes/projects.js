	...
	return (
		<div className='container mx-auto my-14 px-5 sm:px-2 xs:px-3 lg:px-5 bg-gradient-to-tr text-slate-400'>
			...
			<div className='grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5 lg:gap-14 '>
				...
				<div className='bg-sky-800 h-56'>02</div>
				<div className='bg-sky-800 h-56'>03</div>
				<div className=' bg-sky-800 h-56'>04</div>
				<div className='bg-sky-800 h-56'>05</div>
				<div className='bg-sky-800 h-56'>06</div>
				<div className='bg-sky-800 h-56'>07</div>
				<div className='bg-sky-800 h-56'>08</div>
				<div className=' bg-sky-800 h-56'>09</div>
			</div>
		</div>
	)
}
