...
const projects = [
    {
        name: 'Game Deal Hub – Your game deals hub',
        slug: 'game-deal-hub',
        description:
            'Your game deals hub, find the best deals on games.',
        tech: ['Python', 'Next.js', 'React', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'Vercel', 'Railway'],
        role: 'Personal project – idea, design, frontend & backend',
        liveUrl: 'https://gamedealhub.vercel.app/',
        repoUrl: null,
        status: 'In development',//'Live',
        year: '2026',
        bgImage: 'https://images.pexels.com/photos/2708981/pexels-photo-2708981.jpeg'
    },
    {
        ...
        tech: ['Next.js', 'React', 'TypeScript', 'Leaflet', 'Framer Motion', 'Vercel'],
        role: 'Personal project – idea, design, frontend & backend',
    ...
    {
        name: 'Remix Pallete Generator',
        slug: 'remix-pallete-generator',
        description:
            'A modern pallete generator that lets you generate a pallete of colors based on a primary color.',
        tech: ['Remix', 'React', 'TypeScript', 'Tailwind CSS', 'Vercel'],
        role: 'Personal project – idea, design, frontend & backend',
        liveUrl: 'https://pallete-generator.vercel.app/',
        repoUrl: null,
                ...
                >
                    ...
                    <motion.div variants={itemVariants}>
                        <FeaturedProjectTeaser
                            ...
                            primaryHref={projects[1].liveUrl}
                            primaryText='Open live preview'
                            secondaryHref={projects[1].repoUrl}
                            secondaryText='View source code'
                            showPreview
                            previewImage={projects[1].bgImage}
                                    ...
                                    <div className='grid md:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)] gap-6 md:gap-8'>
                                        ...
                                        <div className='relative overflow-hidden'>
                                            ...
                                            <div className='relative h-full min-h-[220px]'>
                                                {(() => {
                                                    // Ako nema bgImage, pokušaj da iskoristiš OG/preview iz liveUrl (npr. /og-image.png)
                                                    const live = project.liveUrl?.replace(/\/$/, '') || ''
                                                    const ogFallback = live ? `${live}/og-image.png` : ''

                                                    const bg = project.bgImage || ogFallback

                                                    const backgroundImage = bg
                                                        ? `url(${bg})`
                                                        : 'radial-gradient(circle at top, rgba(56,189,248,0.25), transparent 60%), radial-gradient(circle at bottom, rgba(16,185,129,0.25), transparent 60%)'
