...
const PostDetails: React.FC<PostDetailsProps> = ({ data, mdxSource, toc }) => {
	return (
			...
			<div className='grid grid-cols-1 lg:grid-cols-12 gap-x-1 lg:gap-x-12'>
				<div className='col-span-1 lg:col-span-10'>
					...
					<div className='mb-4 lg:mb-10 w-full lg:w-auto border-b border-neutral-800'>
						<CategoryChip categories={data.tags} className="" />
					</div>
...
export const getStaticProps: GetStaticProps<PostDetailsProps, { slug: string }> = async ({ params }) => {
	if (!params?.slug) {
		return {
			notFound: true
		}
