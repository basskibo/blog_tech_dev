export const generateRandomQuestionList = <T,>(questions: T[]): T[] => {
...
export const getRandomQuestions = <T,>(questions: T[], numberOfQuestions: number): T[] => {
...
export const findById = <T extends { id: any }>(list: T[], id: any): T | undefined => {
