...
description: "Simple bash script which I made for upgrading ubuntu OS"
englishOnly: "true"
...
<b><Accent> NOTE you will only have to reboot machine in case packages were updated/upgraded if not you can just go with no </Accent></b>
