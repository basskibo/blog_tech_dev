...
excerpt: "Next.js is a popular framework for building server-rendered React applications. One of the key features of Next.js is its ability to automatically handle the rendering of your pages on both the client and server. In this post, we'll take a closer look at how rendering works in Next.js."
englishOnly: "true"
