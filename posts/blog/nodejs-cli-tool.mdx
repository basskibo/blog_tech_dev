...
If you want to check npm publishing step-by-step you can check my other post <Link href="https://www.jageticbojan.com/post/create-npm-module">5 Simple Steps to Creating Your Very Own npm Module
</Link>.
