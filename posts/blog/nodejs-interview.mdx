...
<Link href='https://npmjs.org'>NPM </Link> represents two things: 1.) it is and online repository
...
<CloudinaryImage src='https://res.cloudinary.com/dr1sm5gnj/image/upload/v1645182872/igutech/Event_2_whn6nw.jpg' text='Representation of event loop' alt='Representation of event loop' />
