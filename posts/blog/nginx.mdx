...
### IP Hash (ip_hash)
<Accent>Algorithm:</Accent> Assigns requests to upstream servers based on the client's IP address. This ensures that requests from the same IP address are consistently routed to the same server.

<Adjusted2F90B831DD842160A6782FDA3D8818652122BCE5B0650E725D0B8FCE441DE0D4>Use Case:</Adjusted2F90B831DD842160A6782FDA3D8818652122BCE5B0650E725D0B8FCE441DE0D4> Useful when maintaining session state on the server is important, such as for applications with user sessions.
