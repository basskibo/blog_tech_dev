...
After build is done you will have generated sitemap.xml and sitemap-0.xml at <code>public</code> folder by default.If you set generateRobotsTxt to true you will get robots.txt file as well. 
