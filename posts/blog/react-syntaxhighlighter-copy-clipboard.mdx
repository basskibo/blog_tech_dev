...
```
<b>NOTE</b> I am using all this modules in my specific case, for my <Link href="https://www.jageticbojan.com/">blog/portfolio website</Link> (you can check there how it looks in real example) but you do not have to use all of this, also you can use similar modules like clipboard.js or react-hot-toast for example.
...
```
You can check final look on my <Link href="https://www.jageticbojan.com/post/react-syntaxhighlighter-copy-clipboard">personal blog</Link> or you can check video example how this really look
